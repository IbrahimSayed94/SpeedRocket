...
public class ProductsScreen extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener{
    ...
    String enTitle , enDescription , productImage , companyName;
    int productId , price;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ProductAdapter(productList1, getApplicationContext());
                    ...
                    public void onResponse(Call<ResultModel> call, Response<ResultModel> response) {
                        try
                        {
                            ...
                            for(int i =0 ; i< productList.size(); i++)
                            {
                                ...
                                product = new Product(productId,enTitle,enDescription,productImage,companyName,price);
